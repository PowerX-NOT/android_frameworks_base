...
final class ActivityRecord extends WindowToken {
    ...
    private int getStartingWindowType(boolean newTask, boolean taskSwitch, boolean processRunning,
        ...
        boolean isAppLockerActivity = AppLockService.get().isAuthActivity(this.intent.getComponent());
        if (AppLockService.get().isAppLocked(this) || isAppLockerActivity) {
    ...
    private void finishActivityResults(int resultCode, Intent resultData,
        ...
        if (AppLockService.get().checkUnlockApp(this, resultCode, resultData)) {
            resultTo = null;
        }
    ...
    private boolean transferStartingWindow(@NonNull ActivityRecord fromActivity) {
        ...
        if (tStartingWindow != null && fromActivity.mStartingSurface != null) {
            ...
            if (AppLockService.get().isAuthActivity(this.intent.getComponent())) {
                return false;
            }
    ...
    void stopIfPossible() {
        ...
        if (isNoHistory()) {
            if (AppLockService.get().isAppLocked(this)) {
